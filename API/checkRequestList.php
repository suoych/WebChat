...
$sqlcheck = ("select  requestID, addFriend.userID, imageUrl from addFriend, user where friendID = '$friendID' and user.userID = addFriend.userID and addFriend.state = '0';");
