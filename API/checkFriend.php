...
$sqlcheck = ("select nickname, signature, gender, email, imageUrl, remark, groupName from friend, user where friendID = user.userID and friend.userID = '$userID' and friendID = '$friendID';");
