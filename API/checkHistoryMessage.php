...
$sqlcheck = ("select userID,friendID,type,text,imageUrl,sendTime from message where (userID = '$userID' and friendID = '$friendID') or (userID = '$friendID' and friendID = '$userID');");
